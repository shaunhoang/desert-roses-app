...
# III. The code behind the scene

Here are some highlights of what goes on behind the scene of the web app.

### Calculating Desertification Risk Index 2014-2023 from Land-8 dataset
...
After we applied the index calculation, we masked out DRI values less than 0.5 to highlight areas with high risk of desertification.
...
We also added a legend for the DRI value with a colour scale.
...
![High DRI areas nationwide with values below 0.5 masked out](images/clipboard-503500441.png){fig-align="center" width="1000"}
...
![Change in DRI 2014-2023. Lighter pixels see a higher increase in DRI, while darker ones see a decrease in DRI.](images/clipboard-2172427467.png){fig-align="center" width="1000"}
...
![Desertification in populated areas (i.e. High-risk areas). Left: By DRI values . Right: By Population Density.](images/clipboard-3677790972.png){width="1000"}
...
![The app's UI after the year and area of interest have been indicated](images/clipboard-3754887948.png){fig-align="center" width="2504"}
